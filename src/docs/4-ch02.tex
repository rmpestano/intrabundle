...
\subsubsection{Example}
Below is an example of facet that restricts the usage of hello-world plugin, in the example the command should be only available when user is in a directory named \emph{hello}.
...
public class HelloFacet implements Facet {
   ...
   @Override
    public boolean isInstalled() {
         return project != null && project.getProjectRoot().getName().equals("hello");
    }
